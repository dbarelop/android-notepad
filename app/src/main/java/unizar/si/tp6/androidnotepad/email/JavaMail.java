...
public class JavaMail extends Authenticator {
     ...
     *
     * @return true for success sending the message, false otherwise
     ...
     *
     * @param filename name of the file to attach to the email
     * @throws Exception if any problem
	 */
	...
	/**
	 * @return an object representing the password authentication
	 */
