 ...
 */
public class Test_old<T extends Testable_old> implements Runnable {
    private final T obj;
    private final Method m;

    public Test_old(T obj, Method m) {
        this.obj = obj;
        this.m = m;
    }
    ...
    public void test(Testable_old obj, Method m) throws NotTestableException {
